...
public class SelectHero : MonoBehaviour {
    ...
    public UISprite[] mHeroSpriteList;
      ...
      //  {
      //      EventCenter.AddListener(GameEventEnum.GameEvent_HeroEnter, Show);
      //      EventCenter.AddListener(GameEventEnum.GameEvent_HeroExit, Hide);


      //      EventCenter.AddListener<int>(GameEventEnum.GameEvent_HeroFirstTime,  SetFirstTime);
      //      EventCenter.AddListener<int>(GameEventEnum.GameEvent_HeroSecondTime, SetSecondTime);
      //  }

      //  //类对象释放
      //  public override void Realse()
      //  {
      //      EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroEnter, Show);
      //      EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroExit, Hide);

      //      EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_HeroFirstTime, SetFirstTime);
      //      EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_HeroSecondTime, SetSecondTime);
      //  }
      ...
      //  {
      //      EventCenter.AddListener(GameEventEnum.GameEvent_HeroPreSelect, UpdateHeroListSelect);//更新英雄选择列表
      //      EventCenter.AddListener<int>(GameEventEnum.GameEvent_HeroRealSelect, HeroSelect);//英雄选择
      //      EventCenter.AddListener(GameEventEnum.GameEvent_HeroAddSelect, HeroAddSelect);//预选英雄显示
      //      EventCenter.AddListener(GameEventEnum.GameEvent_HeroEnterRandom, RandomSelectHero);//随机选择英雄
      //      EventCenter.AddListener<int>(GameEventEnum.GameEvent_HeroReconnectPreSelect, UpdateReconnectPreSelect);//更新预选英雄描述
      //  }

      //  //游戏事件注消
      //  protected override void OnRemoveListener()
      //  {
      //      EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroPreSelect, UpdateHeroListSelect);
      //      EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_HeroRealSelect, HeroSelect);
      //      EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroAddSelect, HeroAddSelect);
      //      EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroEnterRandom, RandomSelectHero);
      //      EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_HeroReconnectPreSelect, UpdateReconnectPreSelect);
      //  }
      ...
      //      IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideRoomBeginBtnEnd);
      ...
      //  {
      //      //UIGuide
      //      IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectHeroHeadStart, StartIGuideTask);
      //      IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectHeroCommitStart, StartIGuideTask);
      ...
      //      //UIGuide
      //      IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectHeroHeadStart, StartIGuideTask);
      //      IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectHeroCommitStart, StartIGuideTask);
      //      IGuideTaskManager.Instance().SendTaskTrigger(GameEventEnum.GameEvent_UIGuideTriggerSelectHero);
      ...
      //  {
      //      IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectHeroHeadEnd);
      //      IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectHeroCommitEnd);
      ...
      //          IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectHeroCommitEnd);
      //          //通知服务器确定选择的英雄
      //          CGLCtrl_GameLogic.Instance.EmsgToss_AskSelectHero((UInt32)HeroCtrl.Instance.heroInfoList[mSelectIndex].HeroSelectNum);
