...
namespace HolyTech.Ctrl
{
    public class LoginCtrl : Singleton<LoginCtrl>
    {
        ...
        public void Enter()
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_LoginEnter);
        ...
        public void Exit()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_LoginExit);
        }
        ...
        public void LoginError(int code)
        {
            ...
            EventCenter.Broadcast<EErrorCode>(GameEventEnum.GameEvent_LoginError, (EErrorCode)code);
        }
        ...
        public void RecvGateServerInfo(Stream stream)
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_LoginSuccess); //登陆成功事件来移除绑定事件
        }
        ...
        {
            NetworkManager.Instance.canReconnect = false;
            EventCenter.Broadcast(GameEventEnum.GameEvent_LoginFail);
        }
        ...
        public void UpdateServerAddr(Stream stream)
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_SdkServerCheckSuccess);
        }
        ...
        public void SelectServer(int id)
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_SelectServer); 
        }       
        ...
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_SdkLogOff);
            SdkLink();            
        }
        public void SdkLink()
        {
