...
{ 
    public class MailCtrl : Singleton<MailCtrl>
    {
        public void Enter()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_MailEnter);
        }

        public void Exit()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_MailExit);
        }
        ...
        { 
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_AddNewMailReq);

            Debug.Log("=====11111111111========");
            EventCenter.Broadcast(GameEventEnum.GameEvent_UpdateMailList);
            Debug.Log("=====11111111111========");
        }
        //更新单封邮件
