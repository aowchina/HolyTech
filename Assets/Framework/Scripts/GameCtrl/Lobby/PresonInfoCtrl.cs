...
namespace HolyTech.Ctrl
{
    public class PresonInfoCtrl : Singleton<PresonInfoCtrl>
    {
        public void Enter()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_PresonInfoEnter);
        }

        public void Exit()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_PresonInfoExit);
        }

        public void ChangeNickName()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_ChangeNickName);
        }
        public void ChangeHeadID()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_ChangeHeadID);
        }
