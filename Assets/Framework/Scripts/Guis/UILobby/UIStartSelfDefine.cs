...
public class UIStartSelfDefine : MonoBehaviour {
    ...
    void OnEnable()
    {
        ...
        DoMoveIn();
        //UIGuide
        IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectPrimaryBtnStart, StartIGuideTask);
        IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideCreateRoomBtnStart, StartIGuideTask);
        IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideTriggerCreateRoom);
    }
    ...
    void StartIGuideTask(GameEventEnum taskId)
    {
        ...
        switch (taskId)
        {
            case GameEventEnum.GameEvent_UIGuideSelectCreateRoomBtnEnd:
                IGuideTaskManager.Instance().SendTaskEffectShow(GameEventEnum.GameEvent_UIGuideSelectCreateRoomBtnEnd);
    ...
    void MoveBackFinish() { 
		IGuideTaskManager.Instance().SendTaskEffectShow(GameEventEnum.GameEvent_UIGuideSelectPrimaryBtnEnd);
       // EnableBoxEvent(true);
    }
    ...
    void AddEvent() {
        ...
        EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_AskAddInBattle, StartSelfResult);
	...
	void OnDisable(){
		...
		EventCenter.RemoveListener<EErrorCode>(GameEventEnum.GameEvent_AskAddInBattle, StartSelfResult);
		IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectPrimaryBtnStart, StartIGuideTask);
        IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideCreateRoomBtnStart, StartIGuideTask);
	}
	void BtnCreateOrAdd()
	{
...
//	}
	private void StartBtnOnPress(int ie, bool press)
	{
        ...
        {
            IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectPrimaryBtnEnd);
        }
	}
	public void CreateOrAddRoom(){
		if(string.Equals(BtnCreateRoom.GetComponentInChildren<UILabel>().text,CreateRoom))
		{
            IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectCreateRoomBtnEnd);
