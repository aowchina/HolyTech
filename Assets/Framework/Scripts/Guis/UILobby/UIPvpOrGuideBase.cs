...
public class UIPvpOrGuideBase : MonoBehaviour
{
	...
	void OnEnable()
	{
        ...
        MoveSprite.count = 0;
        //UIGuide
        IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideNewsGuideStart, StartIGuideTask);
        IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelfDefBtnStart, StartIGuideTask);
        IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideMatchBtnStart, StartIGuideTask); 
        IGuideTaskManager.Instance().SendTaskTrigger(GameEventEnum.GameEvent_UIGuideTriggerNewsGuide);
        IGuideTaskManager.Instance().SendTaskTrigger(GameEventEnum.GameEvent_UIGuideTriggerSelfDefGame);
	...
	void OnDisable()
	{
		IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideNewsGuideStart, StartIGuideTask);
        IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelfDefBtnStart, StartIGuideTask);
        IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideMatchBtnStart, StartIGuideTask); 
		...
		//if (isKeyPress) {
			...
			switch ((BUTTON_STATE)ie) {
			 case BUTTON_STATE.BTNCUSTOM:
                IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelfDefBtnEnd);
	...
	void SetTimeLabel(MAPTYPE _type,int ie)
	{
        ...
        {
            IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideMatchBtnEnd);            
        }
    ...
    {
        IGuideTaskManager.Instance().SendTaskEffectShow(GameEventEnum.GameEvent_UIGuideNewsGuideEnd);
        IGuideTaskManager.Instance().SendTaskEffectShow(GameEventEnum.GameEvent_UIGuideSelfDefBtnEnd);
