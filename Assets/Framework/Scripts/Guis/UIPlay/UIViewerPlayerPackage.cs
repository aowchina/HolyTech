...
public class UIViewerPlayerPackage : MonoBehaviour {
    ...
    void OnEnable()
    {
        Instance = this;
        Init();
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_PackageBuyInfo, SetPlayerage);
    }
    void OnDisable()
    {
        Instance = null;
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_PackageBuyInfo, SetPlayerage);
    }
