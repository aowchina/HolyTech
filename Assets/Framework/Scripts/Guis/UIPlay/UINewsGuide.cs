...
public class UINewsGuide : MonoBehaviour
{
    ...
    {
        Instance = this;
        //EventCenter.AddListener<UInt64, int, int, int>(GameEventEnum.GameEvent_GuideKillTask, OnEvent);
        EventCenter.AddListener<bool>(GameEventEnum.GameEvent_GuideShowBuildingTips, OnShowBuildingTips);
        isSet = false;
    }

    void OnDisable() {
        //EventCenter.RemoveListener<UInt64, int, int, int>(GameEventEnum.GameEvent_GuideKillTask, OnEvent);
        EventCenter.RemoveListener<bool>(GameEventEnum.GameEvent_GuideShowBuildingTips, OnShowBuildingTips);
    }
