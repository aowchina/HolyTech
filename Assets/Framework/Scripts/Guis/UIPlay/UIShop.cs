...
public class UIShop : MonoBehaviour {
    ...
    void SendOpenShop(bool tag) {
        CEvent eve = new CEvent(GameEventEnum.GameEvent_NotifyOpenShop);
    ...
    public void InitShop(int shopId)
    {
        ...
        EventCenter.AddListener(GameEventEnum.GameEvent_UpdateUserGameItems, use.OnShowItemInUserInterface);        
    ...
    void OnDisable()
    {
        ...
        {
            UserPackageItem use = (UserPackageItem)ShopItemAll[ShopSelectType.TypeUser];
            if (EventCenter.mEventTable.ContainsKey(GameEventEnum.GameEvent_UpdateUserGameItems))
            {
                EventCenter.RemoveListener(GameEventEnum.GameEvent_UpdateUserGameItems, use.OnShowItemInUserInterface);
            }
        }
