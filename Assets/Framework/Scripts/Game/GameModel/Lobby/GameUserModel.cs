...
namespace HolyTech.Model
{
    public class GameUserModel : Singleton<GameUserModel>
    {
        ...
        public void GameUserCurDiamond(UInt64 value)
        {
            ...
            mGameUserDmd = value;
            EventCenter.Broadcast(GameEventEnum.GameEvent_ChangeMoney);
        }
        ...
        {
            UserLevel = lv;
            EventCenter.Broadcast(GameEventEnum.GameEvent_ChangeUserLevel);
        }
        ...
        public void DeltGetHeroInfoData(CommodityInfos info)
        {
            ...
            else
            {
                ...
                EventCenter.Broadcast<int>(GameEventEnum.GameEvent_CsGetNewHero, info.goodsId);
            }
            
            EventCenter.Broadcast<int>(GameEventEnum.GameEvent_RefreshGoodHero, info.goodsId);
            EventCenter.Broadcast<int>(GameEventEnum.GameEvent_RefreshTimeLimitHero, info.goodsId);
        }
        ...
        public void GameUserGetNewCommodity(int Cmdityid)
        {
            ...
            {
                //EventCenter.Broadcast<EMessageType>(GameEventEnum.GameEvent_ShowMessage, EMessageType.EMT_BuyGoodsSuccess);
