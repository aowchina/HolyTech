...
namespace HolyTech.GameState
{
    class PlayState : IGameState
    {
        ...
        {
            return GameStateTypeEnum.GS_Play;
        } 
        ...
        public void Enter()
        {
            ...
            //正常流程
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_GameOver, OnGameOver);//状态转换到GS_Over
            //新手引导流程
            ...
            EventCenter.AddListener(GameEventEnum.GameEvent_ReconnectToBatttle, OnReconnectToBatttle);       
            //获取地图信息
            GetMapType();
        }
        ...
        public void GetMapType()
        {
            ...
            if (UIGuideModel.Instance.GuideType == GCToCS.AskCSCreateGuideBattle.guidetype.first)
            {
                ...
                EventCenter.Broadcast(GameEventEnum.GameEvent_PlayTaskModelFinish);
            }
        ...
        public void Exit()
        {
            ...
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ReconnectToBatttle, OnReconnectToBatttle);     
        ...
        private void OnGameOver(UInt64 BaseGuid)
        {
            ...
            GameStateManager.Instance.ChangeGameStateTo(GameStateTypeEnum.GS_Over);
        ...
        private void SdkLogOff()
        {
            ...
            LoadingState lState = GameStateManager.Instance.getState(GameStateTypeEnum.GS_Loading) as LoadingState;
            lState.SetNextState(GameStateTypeEnum.GS_Login);
            lState.SetFrontScenes(View.EScenesType.EST_Play);
            SetStateTo(GameStateTypeEnum.GS_Loading);
        }
