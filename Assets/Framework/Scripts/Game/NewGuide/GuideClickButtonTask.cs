...
namespace HolyTech.GuideDate
{
    public class GuideClickButtonTask : GuideTaskBase
    {
        ...
        {
            EventCenter.AddListener<GameObject>(GameEventEnum.GameEvent_GuideLockTargetCanAbsorb, OnGuideTaskEvents);
            EventCenter.AddListener<GameObject>(GameEventEnum.GameEvent_GuideLockTargetCanNotAbsorb, OnGuideTaskRemoveEvent);
        ...
        public override void ClearTask()
        {
            ...
            EventCenter.RemoveListener<GameObject>(GameEventEnum.GameEvent_GuideLockTargetCanAbsorb, OnGuideTaskEvents);
            EventCenter.RemoveListener<GameObject>(GameEventEnum.GameEvent_GuideLockTargetCanNotAbsorb, OnGuideTaskRemoveEvent);
        }
    }
