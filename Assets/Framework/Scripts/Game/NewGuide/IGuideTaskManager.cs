...
namespace HolyTech.GuideDate
{
    public class IGuideTaskManager
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_ScenseChange, ChangeScense);
        }

        ~IGuideTaskManager()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ScenseChange, ChangeScense);
        }
        ...
        public void SendTaskEnd(GameEventEnum gameEve)
        {
        ...
        public void SendTaskTrigger(GameEventEnum gameEve)
        {
            SendTaskEnd(gameEve);
        }

        public void SendTaskStart(GameEventEnum gameEnd, GameEventEnum gameStart)
        {
            EventCenter.Broadcast(gameStart, gameEnd);
        }

        public void AddTaskStartListerner(GameEventEnum gameEve, Callback<GameEventEnum> back)
        {
            EventCenter.AddListener<GameEventEnum>(gameEve, back);
        }

        public void RemoveTaskStartListerner(GameEventEnum gameEve, Callback<GameEventEnum> back)
        {
            if (EventCenter.mEventTable.ContainsKey(gameEve))
            {
                EventCenter.RemoveListener<GameEventEnum>(gameEve, back);
            }
        }

        public void SendTaskMarkObjList(GameEventEnum gameEve, List<GameObject> objList)
        {
        ...
        public void SendTaskEffectShow(GameEventEnum gameEve)
        {
            CEvent eve = new CEvent(gameEve);
