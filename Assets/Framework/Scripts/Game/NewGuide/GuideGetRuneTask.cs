...
namespace HolyTech.GuideDate
{
    public class GuideGetRuneTask : GuideTaskBase
    {
        ...
        {
            EventCenter.AddListener<uint, int, long>(GameEventEnum.GameEvent_RuneBagUpdate, GetRuneEvent);
        }
        ...
        {
            EventCenter.RemoveListener<uint, int, long>(GameEventEnum.GameEvent_RuneBagUpdate, GetRuneEvent);
            base.ClearTask();
        }
