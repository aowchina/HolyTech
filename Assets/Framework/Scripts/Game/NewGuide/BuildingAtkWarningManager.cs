...
namespace HolyTech.GuideDate
{
    ...
    {        
        ...
        {
            EventCenter.AddListener<UInt64, uint, UInt64>(GameEventEnum.GameEvent_BroadcastBeAtk, OnSkillModelHitTarget); 
        }

        ~BuildingAtkWarningManager() {
            EventCenter.RemoveListener<UInt64, uint, UInt64>(GameEventEnum.GameEvent_BroadcastBeAtk, OnSkillModelHitTarget); 
        }
