...
namespace HolyTech.GuideDate
{
    ...
    {        
        ...
        public BuildingAtkWarning() {
            EventCenter.AddListener<Ientity>(GameEventEnum.GameEvent_NotifyBuildingDes, OnBuildingDead);
        }

        ~BuildingAtkWarning() {
            EventCenter.RemoveListener<Ientity>(GameEventEnum.GameEvent_NotifyBuildingDes, OnBuildingDead);
        }
