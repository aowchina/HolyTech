...
namespace HolyTech.GuideDate
{
    public class GuideAbsorbTask : GuideTaskBase
    {
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_GuideAbsorbTask, GetAbsorbEvent);
        }
        ...
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_GuideAbsorbTask, GetAbsorbEvent);
            base.ClearTask();
        }
