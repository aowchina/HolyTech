...
namespace HolyTech.GuideDate
{
    public class AdGuideGetCpTask : GuideTaskBase
    {
        ...
        public override void EnterTask()
        {
            ...
            EventCenter.AddListener(GameEventEnum.GameEvent_PlayerGetCp, OnGuideTaskEvents);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PlayerGetCp, OnGuideTaskEvents);
            base.ClearTask();
        }
