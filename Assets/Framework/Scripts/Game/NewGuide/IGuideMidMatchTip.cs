...
namespace HolyTech.GuideDate
{
    public class IGuideMidMatchTip : Singleton<IGuideMidMatchTip>
    {
        ...
        public void RegisterListerner()
        {
            ...
            {
                EventCenter.AddListener<long>(GameEventEnum.GameEvent_BattleTimeDownEnter, OnEvent);
        ...
        void OnEvent(long i) {
            EventCenter.RemoveListener<long>(GameEventEnum.GameEvent_BattleTimeDownEnter, OnEvent);    
            TimeSpan span = GameTimeData.Instance.GetGameTime();
