...
namespace HolyTech.Ctrl
{
    public class InviteCtrl : Singleton<InviteCtrl>
    {
        ...
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_InviteEnter,sGUID,nickName);
        }

        public void Exit()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_InviteExit);
        }

        public void ChangeInvite(UInt64 sGUID, string nickName)
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_InviteChange,sGUID,nickName);
        }
