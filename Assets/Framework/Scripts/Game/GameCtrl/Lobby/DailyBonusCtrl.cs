...
namespace HolyTech.Ctrl
{
    ...
    public class DailyBonusCtrl : Singleton<DailyBonusCtrl>
    {
        ...
        public void Enter()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_DailyBonusEnter);
        }

        public void Exit()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_DailyBonusExit);
        }
        ...
        public void SetDayAwards(uint month, uint today, uint maxdays, uint haddays, bool isTodayCan)
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_DailyBonusUpdate);
        }
