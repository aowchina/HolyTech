...
namespace HolyTech.Ctrl
{
    public class UIGuideCtrl : Singleton<UIGuideCtrl>
    {
        public void Enter()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_PlayGuideEnter);
        }

        public void Exit()
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_PlayGuideExit);
        }
        ...
        public void AddUiGuideEventBtn(GameObject gobj)
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_UIGuideEvent, gobj);
        }
