...
public class UIViewerSkillInfo : MonoBehaviour {
    ...
    void OnEnable()
    {
        Instance = this;
        Init();
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_AbsSkillInfo, AddHeroAbsorbSkill);//添加英雄吸附技能
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_SkillInfo, InitHeroSkills);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_SkillUpLvChange, SkillUpgrade);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_SkillCDInfo, ChangeSkillCd);

    }
    void OnDisable()
    {
        Instance = null;
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_AbsSkillInfo, AddHeroAbsorbSkill);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_SkillInfo, InitHeroSkills);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_SkillUpLvChange, SkillUpgrade);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_SkillCDInfo, ChangeSkillCd);
    }
    //skill slot
    class SkillSlot
    {
    ...
    void OnPress(int ie, bool isPress)
    {
        ...
        EventCenter.Broadcast<bool, SkillTypeEnum, Iplayer>(GameEventEnum.GameEvent_SkillDescribleType, false, SkillTypeEnum.SKILL_NULL, player);
    }
    ...
    void Update()
    {
        ...
        {
            EventCenter.Broadcast<bool, int, Iplayer>(GameEventEnum.GameEvent_SkillDescribleId, true, skillDic[player].GetSkillId(curSlot), player);
