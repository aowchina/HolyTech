...
public class UIMiniMapPlayerElement : UIMiniMapElement
{
    ...
    {
        EventCenter.AddListener(GameEventEnum.GameEvent_ChangeMapState, ChangeMapState);
    }

    private void OnDisable()
    {
        EventCenter.RemoveListener(GameEventEnum.GameEvent_ChangeMapState, ChangeMapState);
    }
