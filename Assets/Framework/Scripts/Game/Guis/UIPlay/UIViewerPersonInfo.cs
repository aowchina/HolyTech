...
public class UIViewerPersonInfo : MonoBehaviour {//测试不到哪种有情况会使用此脚本
    ...
    void OnEnable()
    {
        ...
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_HeroInfoChange, OnUpdateHeroInfo);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_HeroHpChange, OnUpdateHeroHp);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_HeroLvChange, OnUpdateHeroLevel);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_HeroMpChange, OnUpdateHeroMp);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_HeroDeathTime, OnUpdateHeroDeathTime);
        EventCenter.AddListener<Iplayer>(GameEventEnum.GameEvent_PersonInitInfo, InitViewPersonInfo);
    }

    void OnDisable()
    {
        Instance = null;
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_HeroInfoChange, OnUpdateHeroInfo);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_HeroHpChange, OnUpdateHeroHp);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_HeroLvChange, OnUpdateHeroLevel);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_HeroMpChange, OnUpdateHeroMp);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_HeroDeathTime, OnUpdateHeroDeathTime);
        EventCenter.RemoveListener<Iplayer>(GameEventEnum.GameEvent_PersonInitInfo, InitViewPersonInfo);
    }
