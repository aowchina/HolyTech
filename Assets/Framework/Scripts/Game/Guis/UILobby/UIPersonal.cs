...
public class UIPersonal : MonoBehaviour {
    ...
    void OnEnable() {
        ...
        EventCenter.AddListener(GameEventEnum.GameEvent_PersonInitInfo, SetCurrentDate);
    }
    void OnDisable()
    {
        Instance = null;
        EventCenter.RemoveListener(GameEventEnum.GameEvent_PersonInitInfo, SetCurrentDate);
    }
