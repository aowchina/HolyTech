...
namespace HolyTech.View
{
    public class RoomWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_RoomEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_RoomExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RoomEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RoomExit, Hide);
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_RoomEnd, ShowRoomEnd);
            EventCenter.AddListener(GameEventEnum.GameEvent_SeatPosUpdate, RrefreshSeat);
            EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_AskBeginBattleError, BeginBattleError);
            EventCenter.AddListener<uint,string>(GameEventEnum.GameEvent_RecvChatMsg,ShowTalk);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RoomEnd, ShowRoomEnd);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SeatPosUpdate, RrefreshSeat);
            EventCenter.RemoveListener<EErrorCode>(GameEventEnum.GameEvent_AskBeginBattleError, BeginBattleError);
            EventCenter.RemoveListener<uint, string>(GameEventEnum.GameEvent_RecvChatMsg, ShowTalk);
        }
       ...
       //效果
        ...
        void InitEffect()
        {
            ...
            //UIGuide 
            IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideRoomBeginBtnStart, StartIGuideTask);
            IGuideTaskManager.Instance().SendTaskTrigger(GameEventEnum.GameEvent_UIGuideTriggerRoomBeginGame);

            IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideBackLobbyBtnStart, StartIGuideTask);
            IGuideTaskManager.Instance().SendTaskTrigger(GameEventEnum.GameEvent_UIGuideTriggerBackLobby);
        }
        ...
        void FinishMove()
        {
            ...
            //UIGuide
            IGuideTaskManager.Instance().SendTaskEffectShow(GameEventEnum.GameEvent_UIGuideRoomBeginBtnEnd);
            IGuideTaskManager.Instance().SendTaskEffectShow(GameEventEnum.GameEvent_UIGuideBackLobbyBtnEnd);
        ...
        void BtnEvent(int ie, bool pressed)
        {
            ...
            switch ((GameRoomBtn)ie)
            {
                ...
                case GameRoomBtn.LEAVEBATTLE:
                    IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideBackLobbyBtnEnd);
