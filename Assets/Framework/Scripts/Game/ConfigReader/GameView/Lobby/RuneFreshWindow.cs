...
namespace HolyTech.View
{
    public class RuneRefreshWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneRefeshWindowEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneRefeshWindowExit, Hide);
            EventCenter.AddListener(GameEventEnum.GameEvent_HomePageExit, ParentClose);
        }
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneRefeshWindowEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneRefeshWindowExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HomePageExit, ParentClose);
        }
        ...
        public void onClickWash()
        {
            ...
            EventCenter.Broadcast<EMessageType, string, Callback<bool>>(GameEventEnum.GameEvent_ShowLogicMessage, EMessageType.EMT_SureToWash, showStr, windowsCallBack);
        }
        ...
        {
            EventCenter.AddListener<uint, int, long>(GameEventEnum.GameEvent_RuneBagUpdate, RefeshRuneBagInfo);
            EventCenter.AddListener<uint, int, long>(GameEventEnum.GameEvent_RuneRefreshCardUpdate, RefeshCardInfo);
        ...
        {
            EventCenter.RemoveListener<uint, int, long>(GameEventEnum.GameEvent_RuneBagUpdate, RefeshRuneBagInfo);
            EventCenter.RemoveListener<uint, int, long>(GameEventEnum.GameEvent_RuneRefreshCardUpdate, RefeshCardInfo);
        ...
        public override void Update(float deltaTime)
        {
            if (m_SuccessTime > 0)
            {
                if (Time.time - m_SuccessTime >= 0.8)
                {
                    ...
                    EventCenter.Broadcast<EPurchaseType, string, string, int>(GameEventEnum.GameEvent_PurchaseRuneSuccessWin, EPurchaseType.EPT_Rune, runeCfg.RuneName, runeCfg.Icon, 1);
                    m_SuccessTime = -1;
                }
            }
        }
