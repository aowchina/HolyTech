...
namespace HolyTech.View
{
    public class MarketHeroInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketHeroInfoEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketHeroInfoExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketHeroInfoEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketHeroInfoExit, Hide);
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroInfo);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroInfo);
        }
