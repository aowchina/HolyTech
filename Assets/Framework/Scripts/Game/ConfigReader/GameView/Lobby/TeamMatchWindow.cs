...
namespace HolyTech.View
{
    ...
    public class TeamMatchWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchExit, Hide);
        ...
        {
            EventCenter.AddListener<Teammate>(GameEventEnum.GameEvent_TeamMatchAddTeammate, AddTeammate);
            EventCenter.AddListener<string>(GameEventEnum.GameEvent_TeamMatchDelTeammate, DelTeammate);

            EventCenter.AddListener<Friend>(GameEventEnum.GameEvent_CreateFriendPrefab, AddFriend);
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_RemoveFriend, DelFriend);
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_FriendChangeInfo, ChangeOnLine);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<Teammate>(GameEventEnum.GameEvent_TeamMatchAddTeammate, AddTeammate);
            EventCenter.RemoveListener<string>(GameEventEnum.GameEvent_TeamMatchDelTeammate, DelTeammate);

            EventCenter.RemoveListener<Friend>(GameEventEnum.GameEvent_CreateFriendPrefab, AddFriend);
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_RemoveFriend, DelFriend);
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_FriendChangeInfo, ChangeOnLine);
