...
namespace HolyTech.View
{
    public class InviteWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<UInt64,string>(GameEventEnum.GameEvent_InviteEnter, InvateEnter);
            EventCenter.AddListener(GameEventEnum.GameEvent_InviteExit, Hide);
        ...
        {
            EventCenter.RemoveListener<UInt64, string>(GameEventEnum.GameEvent_InviteEnter, InvateEnter);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_InviteExit, Hide);
        ...
        {
            EventCenter.AddListener<UInt64, string>(GameEventEnum.GameEvent_InviteChange, UpdataNew);
        }

         //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<UInt64, string>(GameEventEnum.GameEvent_InviteChange, UpdataNew);
        }
