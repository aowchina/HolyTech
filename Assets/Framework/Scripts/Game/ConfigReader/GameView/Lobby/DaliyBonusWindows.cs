...
namespace HolyTech.View
{
    ...
    public class DaliyBonusWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_DailyBonusEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_DailyBonusExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_DailyBonusEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_DailyBonusExit, Hide);
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_DailyBonusUpdate, OnEvent_DailyBonusUpdate);
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_InfiniteTaskUpdate);
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyDailyTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.AddListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskAdd, OnEvent_OneTaskAdd);
            EventCenter.AddListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskUpdate, OnEvent_OneTaskUpdate);
            EventCenter.AddListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskDel, OnEvent_OneTaskDel);
            EventCenter.AddListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskRewards, OnEvent_OneTaskRewards);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_DailyBonusUpdate, OnEvent_DailyBonusUpdate);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_InfiniteTaskUpdate);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyDailyTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.RemoveListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskAdd, OnEvent_OneTaskAdd);
            EventCenter.RemoveListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskUpdate, OnEvent_OneTaskUpdate);
            EventCenter.RemoveListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskDel, OnEvent_OneTaskDel);
            EventCenter.RemoveListener<CTask>(GameEventEnum.GameEvent_NotifyOneTaskRewards, OnEvent_OneTaskRewards);
        }
        ...
        private void OnDaliyGameObjsClick(GameObject obj)
        {
            ...
            EventCenter.Broadcast(GameEventEnum.GameEvent_PurchaseSuccessWindowEnter);
            int pos = -1;
            foreach (string itemStr in bonus.n32ItemID)
            {
                ...
                if (itemID == 1)
                {
                    EventCenter.Broadcast<EPurchaseType, string, string, int>(GameEventEnum.GameEvent_PurchaseRuneSuccessWin, 
