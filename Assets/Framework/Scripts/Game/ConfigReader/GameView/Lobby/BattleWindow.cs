...
namespace HolyTech.View
{
   //大厅战斗主界面，包括创建房间，加入房间， 匹配选择等
    public class BattleWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_BattleEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_BattleExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_BattleEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_BattleExit, Hide);
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_BattleUpdateRoomList, UpdateRoomList);
            EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_AskFriendEorr, EventError);
            EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_AskAddInBattle, EventError);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_BattleUpdateRoomList, UpdateRoomList);
