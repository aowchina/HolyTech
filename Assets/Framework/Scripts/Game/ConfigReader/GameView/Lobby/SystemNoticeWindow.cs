...
namespace HolyTech.View
{
    public class SystemNoticeWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_SystemNoticeEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_SystemNoticeExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SystemNoticeEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SystemNoticeExit, Hide);
