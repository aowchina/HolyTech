...
namespace HolyTech.View
{
    ...
    public class RuneCombineWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneCombineWindowEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneCombineWindowExit, Hide);
                ...
                case RuneComposeState.step2:
                    {
                        ...
                        if (curTime - m_ComposeTime >= ComposeStateWaitTime[(int)m_RuneComposeState])
                        {
                            ...
                            EventCenter.Broadcast<EPurchaseType, string, string, int>(GameEventEnum.GameEvent_PurchaseRuneSuccessWin, EPurchaseType.EPT_Rune, cfg.RuneName, cfg.Icon, 1);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneCombineWindowEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneCombineWindowExit, Hide);
