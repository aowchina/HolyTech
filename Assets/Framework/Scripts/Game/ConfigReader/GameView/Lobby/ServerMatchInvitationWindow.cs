...
namespace HolyTech.View
{
    public class ServerMatchInvitationWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<uint,uint>(GameEventEnum.GameEvent_ServerMatchInvitationEnter, ShowUI);
            EventCenter.AddListener(GameEventEnum.GameEvent_ServerMatchInvitationExit, Hide);
        ...
        {
            EventCenter.RemoveListener<uint,uint>(GameEventEnum.GameEvent_ServerMatchInvitationEnter, ShowUI);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ServerMatchInvitationExit, Hide);
