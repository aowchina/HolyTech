...
namespace HolyTech.View
{
    public class LobbyWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_LobbyEnter, Show);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LobbyEnter, Show);
...
//#endif
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeMoney, RefreshMoney);//属刷新金币
            EventCenter.AddListener<bool>(GameEventEnum.GameEvent_ReceiveLobbyMsg, NewChat);
            EventCenter.AddListener(GameEventEnum.GameEvent_AddNewMailReq, NoticeNewMail);//邮件
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeNickName,ChangeNickName);//改昵称
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeHeadID, ChangeHeadID);//改头像
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeUserLevel, ChangeLevel);//改变等级
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeUserLevel, ChangeLevel);//改变等级
        }
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ChangeMoney, RefreshMoney);
            EventCenter.RemoveListener<bool>(GameEventEnum.GameEvent_ReceiveLobbyMsg, NewChat);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AddNewMailReq, NoticeNewMail);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ChangeNickName, ChangeNickName);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ChangeHeadID, ChangeHeadID);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ChangeUserLevel, ChangeLevel);
        }
