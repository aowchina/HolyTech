...
namespace HolyTech.View
{
    public class MailWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_MailEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_MailExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MailEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MailExit, Hide);
        ...
        {
            EventCenter.AddListener<MailData>(GameEventEnum.GameEvent_UpdateMailInfo, UpdateMail); 
            EventCenter.AddListener(GameEventEnum.GameEvent_UpdateMailList, ResetMail);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<MailData>(GameEventEnum.GameEvent_UpdateMailInfo, UpdateMail);
            
            EventCenter.RemoveListener(GameEventEnum.GameEvent_UpdateMailList, ResetMail);
        }
