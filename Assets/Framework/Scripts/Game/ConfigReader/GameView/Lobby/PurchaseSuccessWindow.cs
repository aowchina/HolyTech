...
namespace HolyTech.View
{
    ...
    public class PurchaseSuccessWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_PurchaseSuccessWindowEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_PurchaseSuccessWindowExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PurchaseSuccessWindowEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PurchaseSuccessWindowExit, Hide);
        ...
        {
            EventCenter.AddListener<EPurchaseType, string, string, int>(GameEventEnum.GameEvent_PurchaseRuneSuccessWin, UpdatePurchase);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<EPurchaseType, string, string, int>(GameEventEnum.GameEvent_PurchaseRuneSuccessWin, UpdatePurchase);
        }
