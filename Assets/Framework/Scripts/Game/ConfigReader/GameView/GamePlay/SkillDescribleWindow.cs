...
namespace HolyTech.View
{
    public class SkillDescribleWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<bool,  SkillTypeEnum,  Iplayer >(GameEventEnum.GameEvent_SkillDescribleType, ShowDescribleByType);
        ...
        {
            EventCenter.RemoveListener<bool, SkillTypeEnum, Iplayer>(GameEventEnum.GameEvent_SkillDescribleType, ShowDescribleByType);
