...
namespace HolyTech.View
{
    public class GamePlayGuideWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_PlayGuideEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_PlayGuideExit, Hide);
            //EventCenter.AddListener<GameObject>(GameEventEnum.GameEvent_UIGuideEvent, OnUiGuideAddButtonEvent);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PlayGuideEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PlayGuideExit, Hide);
            //EventCenter.RemoveListener<GameObject>(GameEventEnum.GameEvent_UIGuideEvent, OnUiGuideAddButtonEvent);
        }
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_PlayTaskModelFinish, ExecuteNextGuide);
            EventCenter.AddListener<GuideTaskType, int>(GameEventEnum.GameEvent_PlayChildTaskFinish, OnFinishChildTask);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PlayTaskModelFinish, ExecuteNextGuide);
            EventCenter.RemoveListener<GuideTaskType, int>(GameEventEnum.GameEvent_PlayChildTaskFinish, OnFinishChildTask);
