...
namespace HolyTech.View
{
    public class UserInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_UserEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_UserExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_UserEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_UserExit, Hide);
        }
        ...
        {
            EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_AskComplementedRegisterInfo, RegisterResult);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<EErrorCode>(GameEventEnum.GameEvent_AskComplementedRegisterInfo, RegisterResult);
        }
        ...
        public override void OnEnable()
        {
            ...
            //IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideInputNickNameStart, StartIGuideTask);
            //IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectSexStart, StartIGuideTask);
            //IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectHeadStart, StartIGuideTask);
            //IGuideTaskManager.Instance().AddTaskStartListerner(GameEventEnum.GameEvent_UIGuideCommitRegisterStart, StartIGuideTask);
            //IGuideTaskManager.Instance().SendTaskTrigger(GameEventEnum.GameEvent_UIGuideTriggerRegister);
        ...
        public override void OnDisable()
        {
            ...
            //IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideInputNickNameStart, StartIGuideTask);
            //IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectSexStart, StartIGuideTask);
            //IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideSelectHeadStart, StartIGuideTask);
            //IGuideTaskManager.Instance().RemoveTaskStartListerner(GameEventEnum.GameEvent_UIGuideCommitRegisterStart, StartIGuideTask);
        }
        ...
        //    switch (taskId)
        //    {
        //        case GameEventEnum.GameEvent_UIGuideInputNickNameEnd:
        //            objList.Add(nickNameInput.gameObject);
        //            objList.Add(btnDice.gameObject);
        //            break;
        //        case GameEventEnum.GameEvent_UIGuideSelectSexEnd:
        //            objList.Add(boySelect.gameObject);
        //            objList.Add(girlSelect.gameObject);
        //            objList.Add(nickNameInput.gameObject);
        //            objList.Add(btnDice.gameObject);
        //            break;
        //        case GameEventEnum.GameEvent_UIGuideSelectHeadEnd:
        //            objList.Add(nickNameInput.gameObject);
        //            objList.Add(btnDice.gameObject);
        //            for (int i = 0; i < headList.Count; i++)
        //            {
        ...
        //            }
        //            break;
        //        case GameEventEnum.GameEvent_UIGuideCommitRegisterEnd:
        ...
        //{
        //    IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectSexEnd);
        //}
        ...
        void SelectHead(int ie, bool isDown)
        {
            ...
            IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideSelectHeadEnd);
        }
        ...
        bool CheckNameInput()
        {
            ...
            IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideInputNickNameEnd);
            return true;
        }
        ...
        void SubmitRegister()
        {
            ...
            IGuideTaskManager.Instance().SendTaskEnd(GameEventEnum.GameEvent_UIGuideCommitRegisterEnd);
