...
namespace HolyTech.View
{
    public class ScoreWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_ScoreEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_ScoreExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ScoreEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ScoreExit, Hide);
        }
        ...
        private void ShowBattleResult()
        {
            ...
            if (player.StateSituation == SITUATION.WIN)
            {
                ...
                HolyTech.AudioManager.Instance.PlayLongVoiceAudio(clip);
