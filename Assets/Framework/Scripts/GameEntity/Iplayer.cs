...
namespace HolyTech.GameEntity
{
	public class Iplayer : Ientity
	{
        ...
        {
            if (RealEntity == null || this.entityType == EntityType.Building) return;
        ...
        public override void OnUpdate()
        {
            ...
            {//enemy player
                ...
                if ((this.FSM != null && this.FSM.State == HolyTech.FSM.FsmState.FSM_STATE_DEAD) || (this.realObject.activeSelf == false))
                {
        ...
        protected override void DoReborn()
        {
            ...
            if (this == PlayerManager.Instance.LocalPlayer && FSM.State == HolyTech.FSM.FsmState.FSM_STATE_DEAD)
            {
                GameMethod.GetMainCamera.target = RealEntity.mTransform;
            }
            HolyTech.Effect.EffectManager.Instance.CreateNormalEffect("effect/other/fuhuo", RealEntity.objAttackPoint.gameObject);
            ShowBloodBar(); 
        }
