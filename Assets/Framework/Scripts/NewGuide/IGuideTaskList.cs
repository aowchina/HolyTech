...
namespace HolyTech.GuideDate
{
    public class IGuideTaskList
    {
        ...
        public void OnEnter()
        {
            EventCenter.AddListener<CEvent>((GameEventEnum)taskData.TriggerInterface, OnInterfaceTrigger);
        ...
        public void Clean() {
            ...
            EventCenter.RemoveListener<CEvent>((GameEventEnum)taskData.TriggerInterface, OnInterfaceTrigger);
        }
