...
namespace HolyTech.GuideDate
{
    public class GuideGetHeroTask : GuideTaskBase
    {
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_CsGetNewHero, GetHeroEvent);
        }
        ...
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_CsGetNewHero, GetHeroEvent);
            base.ClearTask();
        }
