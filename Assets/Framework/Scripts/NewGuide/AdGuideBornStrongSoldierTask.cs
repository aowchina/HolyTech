...
namespace HolyTech.GuideDate
{
    public class AdGuideBornStrongSoldierTask : GuideTaskBase
    {
        ...
        public override void EnterTask()
        {
            ...
            EventCenter.AddListener<Ientity>(GameEventEnum.GameEvent_NotifyBuildingDes, OnGuideTaskEvents);
        ...
        {
            EventCenter.RemoveListener<Ientity>(GameEventEnum.GameEvent_NotifyBuildingDes, OnGuideTaskEvents);
            base.ClearTask();
        }
