...
namespace HolyTech.GuideDate
{
    ...
    { 
        ...
        {
            EventCenter.AddListener<CEvent>(GameEventEnum.GameEvent_NotifyHpLessWarning, OnEvent);
        }

        public override void RemoveAddListener()
        {
            if (EventCenter.mEventTable.ContainsKey(GameEventEnum.GameEvent_NotifyHpLessWarning))
            {
                EventCenter.RemoveListener<CEvent>(GameEventEnum.GameEvent_NotifyHpLessWarning, OnEvent);
            }
        }
