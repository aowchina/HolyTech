...
namespace HolyTech.GuideDate
{
    ...
    { 
        ...
        public void CleanAll() {
            ...
            //if (EventCenter.mEventTable.ContainsKey(GameEventEnum.GameEvent_GameOver))
            //{
            //    EventCenter.RemoveListener<CEvent>(GameEventEnum.GameEvent_GameOver, OnGameOver);
            //}
        }

        public void StartAllTask() {
            //EventCenter.AddListener<CEvent>(GameEventEnum.GameEvent_GameOver, OnGameOver);
        ...
        public void SendTaskStartTag(GuideHelpData data) {
            if (data == null)
                return;
            CEvent cEve = new CEvent((GameEventEnum)data.helpTriggerEvent); 
            EventCenter.SendEvent(cEve);
        }

        public void SendTaskEndTag(GuideHelpData data) 
        {
            CEvent cEve = new CEvent((GameEventEnum)(data.helpTriggerEvent + SecondaryTaskInfo.endTaskBetween));
            EventCenter.SendEvent(cEve);
        }
