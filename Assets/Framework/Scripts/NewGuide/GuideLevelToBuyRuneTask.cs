...
namespace HolyTech.GuideDate
{
    ...
    public class GuideLevelToBuyRuneTask : GuideTaskBase
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeUserLevel, OnGuideTaskEvents);
            OnGuideTaskEvents();
        }
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ChangeUserLevel, OnGuideTaskEvents);
            base.ClearTask();
        }
