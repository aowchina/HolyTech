...
namespace HolyTech.GuideDate
{
    public class GuideForceClick : GuideTaskBase
    {
        ...
        {
            //EventCenter.AddListener<ButtonDragType>(GameEventEnum.GameEvent_PlayGuideDragEvent, OnGameObjectDragEvent);
        }
        ...
        public override void ClearTask()
        {
            ...
            //{
            //    EventCenter.RemoveListener<ButtonDragType>(GameEventEnum.GameEvent_PlayGuideDragEvent, OnGameObjectDragEvent);  
            //}
