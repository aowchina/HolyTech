...
namespace HolyTech.View
{
    public class EnemyWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<CEvent>(GameEventEnum.GameEvent_AddOrDelEnemy, OnEvent);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<CEvent>(GameEventEnum.GameEvent_AddOrDelEnemy, OnEvent);
        }
