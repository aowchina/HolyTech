...
namespace HolyTech.View
{
    ...
    public class AdvancedGuideWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_AdvancedGuideEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_AdvancedGuideExit, Hide);
        }
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_AdvancedGuideShowTip, OnEnterGuideTask);
        ...
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_AdvancedGuideShowTip, OnEnterGuideTask);
        ...
        {
            HolyTech.Ctrl.AdvancedGuideCtrl.Instance.Exit();
        }
