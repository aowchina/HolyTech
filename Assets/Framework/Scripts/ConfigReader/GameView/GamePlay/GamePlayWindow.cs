...
namespace HolyTech.View
{
    public class GamePlayWindow : BaseWindow
    {
        ...
        public override void Init()
        {
            ...
            EventCenter.AddListener(GameEventEnum.GameEvent_GamePlayExit, Exit);
        }
        ...
        public override void Realse()
        {
            ...
            EventCenter.RemoveListener(GameEventEnum.GameEvent_GamePlayExit, Exit);
        }
        ...
        private void OnFuryClick(GameObject go)
        {
            ...
            if (PlayerManager.Instance.LocalPlayer.FSM == null ||
               PlayerManager.Instance.LocalPlayer.FSM.State == HolyTech.FSM.FsmState.FSM_STATE_DEAD)
            {
                return;
            }
            CGLCtrl_GameLogic.Instance.AskGasExplosion();//请求爆气  ? ?
        }
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyChangeKills, SetKill);//注册击杀数改变事件
            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerCp, SetCp);//注册金币改变事件
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyChangeDeaths, SetDead);//注册死亡数改变事件
            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerAssist, SetAssist);//注册助攻数改变事件

            EventCenter.AddListener<Ientity>(GameEventEnum.GameEvent_LockTarget, UpdateLockHead);//更新锁定头像
            EventCenter.AddListener<Ientity>(GameEventEnum.GameEvent_EntityHpChange, UpdateHpSlider);//更新实体血条（左上）
            EventCenter.AddListener<Ientity>(GameEventEnum.GameEvent_EntityMpChange, UpdateMpSlider);//更新实体魔法条
            EventCenter.AddListener<CEvent>(GameEventEnum.GameEvent_SSPingInfo, OnEvent);  //游戏状态

            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerHpChange, UpdateHpSlider);//更新本地玩家血条
            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerMpChange, UpdateMpSlider);//更新本地玩家魔法条
            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerExpChange, UpdateExp);//更新经验值

            EventCenter.AddListener<int>(GameEventEnum.GameEvent_LocalPlayerLevelChange, UpdateLevel);//更新本地玩家等级

            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerInit, InitHead);//初始化头像
            EventCenter.AddListener<int, int>(GameEventEnum.GameEvent_LocalPlayerPassiveSkillsUpLv, UpdatePassiveSkills);//更新被动技能
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_LocalPlayerPassiveSkills, SetPassSkill);//设置被动技能
            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerUpdateFuryValue, UpdateFuryValue);//更新狂暴值
            EventCenter.AddListener(GameEventEnum.GameEvent_LocalPlayerUpdateFuryEffect, UpdateFuryEffect);//更新狂暴特效
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyChangeKills, SetKill);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerCp, SetCp);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyChangeDeaths, SetDead);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerAssist, SetAssist);

            EventCenter.RemoveListener<Ientity>(GameEventEnum.GameEvent_LockTarget, UpdateLockHead);
            EventCenter.RemoveListener<Ientity>(GameEventEnum.GameEvent_EntityHpChange, UpdateHpSlider);
            EventCenter.RemoveListener<Ientity>(GameEventEnum.GameEvent_EntityMpChange, UpdateMpSlider);
            EventCenter.RemoveListener<CEvent>(GameEventEnum.GameEvent_SSPingInfo, OnEvent);

            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerHpChange, UpdateHpSlider);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerMpChange, UpdateMpSlider);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerExpChange, UpdateExp);
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_LocalPlayerLevelChange, UpdateLevel);

            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerInit, InitHead);
            EventCenter.RemoveListener<int,int>(GameEventEnum.GameEvent_LocalPlayerPassiveSkillsUpLv, UpdatePassiveSkills);
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_LocalPlayerPassiveSkills, SetPassSkill);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerUpdateFuryValue, UpdateFuryValue);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LocalPlayerUpdateFuryEffect, UpdateFuryEffect);
        }
        ...
        private void UpdateLockHead(Ientity entity)
        {
            ...
            if (entity == null)//如果实体销毁为空了
            {
                ...
                EventCenter.Broadcast<string>(GameEventEnum.GameEvent_ResetLockHead, null);
            }
            else
            {
                string head = "";
                ...
                EventCenter.Broadcast<string>(GameEventEnum.GameEvent_ResetLockHead, head);
                spriteLock.spriteName = head;//锁定的头像（左）
                mLockRoot.localPosition = mLockPos;//根节点的本地位置
                ShowLockEffect(true);//显示锁定特效
                EventCenter.Broadcast<GameObject>((mCanAbsorb) ? GameEventEnum.GameEvent_GuideLockTargetCanAbsorb : GameEventEnum.GameEvent_GuideLockTargetCanNotAbsorb, spriteLockBg2.gameObject);
            }
