...
namespace HolyTech.View
{
    public class SkillWindow : BaseWindow
    {
        ...
        protected override void OnAddListener()
        {
            ...
            EventCenter.AddListener<SkillType, float, float>(GameEventEnum.GameEvent_LocalPlayerSkillCD, OnSkillCountDown);
        ...
        protected override void OnRemoveListener()
        {
            ...
            EventCenter.RemoveListener<SkillType, float, float>(GameEventEnum.GameEvent_LocalPlayerSkillCD, OnSkillCountDown);
        ...
        public override void Update(float deltaTime)
        {
            ...
            {
                EventCenter.Broadcast<bool, SkillType, Iplayer>(GameEventEnum.GameEvent_SkillDescribleType, true, GetSkillType(mCurSkillPress), PlayerManager.Instance.LocalPlayer);
