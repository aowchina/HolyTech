...
namespace HolyTech.View
{
    public class DeathWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyDeathEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_NotifyDeathExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyDeathEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_NotifyDeathExit, Hide);
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_HeroReborn, ExitDeath);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroReborn, ExitDeath);
        }
