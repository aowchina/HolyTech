...
namespace HolyTech.View
{
    ...
    public class BattleInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_BattleInfoEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_BattleInfoExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_BattleInfoEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_BattleInfoExit, Hide);
...
//#endif
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_AllPlayerGoods, Record);
            EventCenter.AddListener(GameEventEnum.GameEvent_AllPlayerAssist, Record);
            EventCenter.AddListener(GameEventEnum.GameEvent_AllPlayerKills, Record);
            EventCenter.AddListener(GameEventEnum.GameEvent_AllPlayerDeaths, Record);
            EventCenter.AddListener(GameEventEnum.GameEvent_AllPlayerLevel, Record);
            EventCenter.AddListener(GameEventEnum.GameEvent_AllPlayerLastHit, Record);
            EventCenter.AddListener(GameEventEnum.GameEvent_HeroAttributesInfo,ShowMine);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AllPlayerGoods, Record);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AllPlayerAssist, Record);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AllPlayerKills, Record);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AllPlayerDeaths, Record);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AllPlayerLevel, Record);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroAttributesInfo, ShowMine);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_AllPlayerLastHit, Record);
        }
