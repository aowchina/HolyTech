...
namespace HolyTech.View
{
    public class SoleSoldierWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_SoleSoldierEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_SoleSoldierExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SoleSoldierEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SoleSoldierExit, Hide);
        }
        ...
        {
            EventCenter.AddListener<int, int>(GameEventEnum.GameEvent_ResetAbsHead, ResetAbsHead);//兵营设置更新吸收头像
            EventCenter.AddListener<string>(GameEventEnum.GameEvent_ResetLockHead, ResetLockHead);
        }

         //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int, int>(GameEventEnum.GameEvent_ResetAbsHead, ResetAbsHead);
            EventCenter.RemoveListener<string>(GameEventEnum.GameEvent_ResetLockHead, ResetLockHead);
        }
