...
namespace HolyTech.View
{
    public class LoginWindow : BaseWindow
    {
        ...
        public override void Init()
        {
            ...
            EventCenter.AddListener(GameEventEnum.GameEvent_LoginEnter, Show);
            //在login.exit()中广播
            EventCenter.AddListener(GameEventEnum.GameEvent_LoginExit, Hide);
        ...
        {
            //移除监听器
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LoginEnter, Show);  
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LoginExit, Hide);
        }
        ...
        {
            EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_LoginError, LoginFail);//登录失败反馈
            EventCenter.AddListener(GameEventEnum.GameEvent_LoginSuccess, LoginSuceess);//登录成功反馈
            EventCenter.AddListener<string, string>(GameEventEnum.GameEvent_SdkRegisterSuccess, SdkRegisterSuccess);//sdk 注册成功，当513的消息返回时启动
            EventCenter.AddListener(GameEventEnum.GameEvent_SdkServerCheckSuccess, SdkServerCheckSuccess);//sdk 检查成功
            EventCenter.AddListener(GameEventEnum.GameEvent_SelectServer, SelectServer);//选择服务器
            EventCenter.AddListener(GameEventEnum.GameEvent_LoginFail, ShowLoginFail);//显示登录界面失败
            EventCenter.AddListener(GameEventEnum.GameEvent_SdkLogOff, SdkLogOff); //SDK退出
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<EErrorCode>(GameEventEnum.GameEvent_LoginError, LoginFail);
            EventCenter.RemoveListener<string,string>(GameEventEnum.GameEvent_SdkRegisterSuccess, SdkRegisterSuccess);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SdkServerCheckSuccess, SdkServerCheckSuccess);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SelectServer, SelectServer);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LoginFail, ShowLoginFail);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LoginSuccess, LoginSuceess);
