...
namespace HolyTech.View
{
    public class RoomInviteWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_RoomInviteEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_RoomInviteExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RoomInviteEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RoomInviteExit, Hide);
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_InviteList, ShowFriendOnLine);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_InviteList, ShowFriendOnLine);
        }
