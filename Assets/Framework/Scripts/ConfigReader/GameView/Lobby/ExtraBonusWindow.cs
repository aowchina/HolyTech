...
namespace HolyTech.View
{
    public class ExtraBonusWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_ExtraBonusEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_ExtraBonusExit, Hide);
            EventCenter.AddListener(GameEventEnum.GameEvent_GameSettingExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ExtraBonusEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ExtraBonusExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_GameSettingExit, Hide);
