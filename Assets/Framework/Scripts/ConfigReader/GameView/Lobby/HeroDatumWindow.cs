...
namespace HolyTech.View
{
    public class HeroDatumWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_HeroDatumEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_HeroDatumExit, Hide);
            EventCenter.AddListener(GameEventEnum.GameEvent_HomePageExit, Hide);
        }
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroDatumEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroDatumExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HomePageExit, Hide);
        }
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_RefreshGoodHero, BuySuccess);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_RefreshGoodHero, BuySuccess);
        }
