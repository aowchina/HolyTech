...
namespace HolyTech.View
{
    public class TeamMatchSearchingWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchSearchinEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchSearchinExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchSearchinEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchSearchinExit, Hide);
        ...
        {
            //玩家匹配数量
            EventCenter.AddListener<int,int>(GameEventEnum.GameEvent_MatchNumber, ChangeMatchNumber);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int,int>(GameEventEnum.GameEvent_MatchNumber, ChangeMatchNumber);
        }
