...
namespace HolyTech.View
{
    public class VIPPrerogativeWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_VIPPrerogativeEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_VIPPrerogativeExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_VIPPrerogativeEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_VIPPrerogativeExit, Hide);
