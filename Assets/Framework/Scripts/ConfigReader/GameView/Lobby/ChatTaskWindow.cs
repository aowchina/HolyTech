...
namespace HolyTech.View
{
    public class ChatTaskWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_ChatTaskEnter, ShowFriendTask);
            EventCenter.AddListener(GameEventEnum.GameEvent_ChatTaskExit, Hide);
        ...
        {
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_ChatTaskEnter, ShowFriendTask);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_ChatTaskExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_LobbyExit, RemoveTask);
        }
        ...
        {
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_ReadyChatTaskEnter, CreateMember);
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_ReceiveNewMsg, ShowTalkInfo);
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_RemoveChatTask, RemovChat);
        }
        ...
        {
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_ReadyChatTaskEnter, CreateMember);
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_ReceiveNewMsg, ShowTalkInfo);
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_RemoveChatTask, RemovChat);
        }
