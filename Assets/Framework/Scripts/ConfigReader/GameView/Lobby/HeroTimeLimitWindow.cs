...
namespace HolyTech.View
{
    public class HeroTimeLimitWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_HeroTimeLimitEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_HeroTimeLimitExit, Hide);
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroTimeLimitEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_HeroTimeLimitExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketExit, Hide);
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_RefreshTimeLimitHero, RefreshMarketHeroList);
            EventCenter.AddListener(GameEventEnum.GameEvent_SdkLogOff, SdkLogOff);
            EventCenter.AddListener<GuideTaskType, int>(GameEventEnum.GameEvent_PlayChildTaskFinish, OnFinishGuideTask);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_RefreshTimeLimitHero, RefreshMarketHeroList);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SdkLogOff, SdkLogOff);
            EventCenter.RemoveListener<GuideTaskType, int>(GameEventEnum.GameEvent_PlayChildTaskFinish, OnFinishGuideTask);
        }
