...
namespace HolyTech.View
{
    public class MarketHeroListWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketHeroListEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketHeroListExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketHeroListEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketHeroListExit, Hide);
        ...
        {
            EventCenter.AddListener<int>(GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroList);
        ...
        {
            EventCenter.RemoveListener<int>(GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroList);
