...
namespace HolyTech.View
{
    public class MarketRuneListWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketRuneListEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketRuneListExit, Hide);
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketExit, ParentClose);
        }
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketRuneListEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketRuneListExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketExit, ParentClose);
            runeListObjects.Clear();
        }
