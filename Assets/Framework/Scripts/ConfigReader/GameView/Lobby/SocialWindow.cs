...
namespace HolyTech.View{
    public class SocialWindow : BaseWindow {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_SocialEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_SocialExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SocialEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_SocialExit, Hide);
        ...
        {
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_RemoveFriendEnd, RemoveGrid);
            EventCenter.AddListener<UInt64>(GameEventEnum.GameEvent_FriendChangeInfo, ChangeOnLine);
            EventCenter.AddListener<Friend>(GameEventEnum.GameEvent_CreateFriendPrefab, NewFriend);
            EventCenter.AddListener(GameEventEnum.GameEvent_CreateBlackPrefab, NewBlack);
            EventCenter.AddListener<EErrorCode>(GameEventEnum.GameEvent_AskFriendEorr, EventError);
        }
        ...
        {
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_RemoveFriendEnd, RemoveGrid);
            EventCenter.RemoveListener<UInt64>(GameEventEnum.GameEvent_FriendChangeInfo, ChangeOnLine);
            EventCenter.RemoveListener<Friend>(GameEventEnum.GameEvent_CreateFriendPrefab, NewFriend);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_CreateBlackPrefab, NewBlack);
            EventCenter.RemoveListener<EErrorCode>(GameEventEnum.GameEvent_AskFriendEorr, EventError);
        }
