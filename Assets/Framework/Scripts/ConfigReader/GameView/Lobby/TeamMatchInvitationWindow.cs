...
namespace HolyTech.View
{
    public class TeamMatchInvitationWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<string>(GameEventEnum.GameEvent_TeamMatchInvitationEnter, ShowUI);
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchInvitationExit, Hide);
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchSearchinEnter, Hide);
        ...
        {
            EventCenter.RemoveListener<string>(GameEventEnum.GameEvent_TeamMatchInvitationEnter, ShowUI);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchInvitationExit, Hide);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchSearchinEnter, Hide);
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_TeamMatchEnter, Hide);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_TeamMatchEnter, Hide);
        }
