...
namespace HolyTech.View
{
    public class RuneEquipWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneEquipWindowEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneEquipWindowExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneEquipWindowEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneEquipWindowExit, Hide);
        ...
        {
            EventCenter.Broadcast(GameEventEnum.GameEvent_RuneRefeshWindowEnter);
        }
        ...
        {
            EventCenter.AddListener<uint, int, int>(GameEventEnum.GameEvent_RuneQuipUpdate, RefeshEquipRuneInfo);
            EventCenter.AddListener<int, int>(GameEventEnum.GameEvent_RuneQuipUnload, UnloadRune);
        ...
        {
            EventCenter.RemoveListener<uint, int, int>(GameEventEnum.GameEvent_RuneQuipUpdate, RefeshEquipRuneInfo);
            EventCenter.RemoveListener<int, int>(GameEventEnum.GameEvent_RuneQuipUnload, UnloadRune);
