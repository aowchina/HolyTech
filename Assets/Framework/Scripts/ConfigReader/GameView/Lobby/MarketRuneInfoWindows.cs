...
namespace HolyTech.View
{
    public class MarketRuneInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<GameObject>(GameEventEnum.GameEvent_MarketRuneInfoEnter, InitRuneInfo);
            EventCenter.AddListener(GameEventEnum.GameEvent_MarketRuneInfoExit, Hide);
        }
        ...
        {
            EventCenter.RemoveListener<GameObject>(GameEventEnum.GameEvent_MarketRuneInfoEnter, ShowWhenRelease);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_MarketRuneInfoExit, Hide);
        }
