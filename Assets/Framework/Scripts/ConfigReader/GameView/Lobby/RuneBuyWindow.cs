...
namespace HolyTech.View
{
    public class RuneBuyWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<GameObject>(GameEventEnum.GameEvent_RuneBuyWindowEnter, InitRuneInfo);
            EventCenter.AddListener(GameEventEnum.GameEvent_RuneBuyWindowExit, Hide);
        ...
        {
            EventCenter.RemoveListener<GameObject>(GameEventEnum.GameEvent_RuneBuyWindowEnter, InitRuneInfo);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_RuneBuyWindowExit, Hide);
