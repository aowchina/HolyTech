...
namespace HolyTech.View
{
    public class PresonInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_PresonInfoEnter, Show);
            EventCenter.AddListener(GameEventEnum.GameEvent_PresonInfoExit, Hide);
        ...
        {
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PresonInfoEnter, Show);
            EventCenter.RemoveListener(GameEventEnum.GameEvent_PresonInfoExit, Hide);
        ...
        {
            if (HolyTech.Ctrl.PresonInfoCtrl.Instance.GetTimeExp() && PresonInfoCtrl.Instance.GetExpLastMin())
                ChangeExpTime();
            if (HolyTech.Ctrl.PresonInfoCtrl.Instance.GetTimeGold() && PresonInfoCtrl.Instance.GetGoldLastMin())
                ChangeGoldTime();
        }
        ...
        {
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeNickName, ChangeNickName);
            EventCenter.AddListener(GameEventEnum.GameEvent_ChangeHeadID, ChangeHeadID);
        }
        ...
        public override void OnEnable()
        {
            ...
            if (HolyTech.Ctrl.PresonInfoCtrl.Instance.GetTimeExp())
                ChangeExpTime();
            if (HolyTech.Ctrl.PresonInfoCtrl.Instance.GetTimeGold())
                ChangeGoldTime();
