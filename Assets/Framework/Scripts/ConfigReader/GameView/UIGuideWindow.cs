...
namespace HolyTech.View
{
    public class UIGuideWindow : BaseWindow
    {
        ...
        {
            //EventCenter.AddListener(GameEventEnum.GameEvent_UIGuideEnter, Show);
            //EventCenter.AddListener(GameEventEnum.GameEvent_UIGuideExit, Hide);
        ...
        {
            //EventCenter.RemoveListener(GameEventEnum.GameEvent_UIGuideEnter, Show);
            //EventCenter.RemoveListener(GameEventEnum.GameEvent_UIGuideExit, Hide);
