...
namespace HolyTech.View
{
    public class TimeDownWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<long>(GameEventEnum.GameEvent_BattleTimeDownEnter, ShowTime);
            EventCenter.AddListener<long>(GameEventEnum.GameEvent_GameStartTime,Stop);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener<long>(GameEventEnum.GameEvent_BattleTimeDownEnter, ShowTime);
            EventCenter.RemoveListener<long>(GameEventEnum.GameEvent_GameStartTime, Stop);
        }
