...
class ReadPreLoadConfig : Singleton<ReadPreLoadConfig>
{
     ...
     public void PreLoad()
    {
        ...
        {                       
            ...
            try
            {
                GameObjectPool.Instance.ReleaseGO(file, preObj, PoolObjectTypeEnum.POT_Effect);
            } catch(Exception e) {
        ...
        {
            GameObjectPool.Instance.ReleaseGO(tipObj.name, tipObj, PoolObjectTypeEnum.POT_UITip);
        }         
    }
