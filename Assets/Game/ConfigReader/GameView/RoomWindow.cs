...
namespace HolyTech.View
{
    public class RoomWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RoomEnd, ShowRoomEnd);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SeatPosUpdate, RrefreshSeat);
            EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskBeginBattleError, BeginBattleError);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RoomEnd, ShowRoomEnd);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SeatPosUpdate, RrefreshSeat);
            EventCenter.RemoveListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskBeginBattleError, BeginBattleError);
