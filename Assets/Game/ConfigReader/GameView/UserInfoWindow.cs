...
namespace HolyTech.View
{
    public class UserInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskComplementedRegisterInfo, RegisterResult);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskComplementedRegisterInfo, RegisterResult);
        }
