   ...
   //大厅战斗主界面，包括创建房间，加入房间， 匹配选择等
    public class BattleWindow : BaseWindow
    {
        ...
        protected override void OnAddListener()
        {
            ...
            EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskFriendEorr, EventError);
            EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskAddInBattle, EventError);
        }
        ...
        protected override void OnRemoveListener()
        {
            ...
            EventCenter.RemoveListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskFriendEorr, EventError);
            EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskAddInBattle, EventError);
