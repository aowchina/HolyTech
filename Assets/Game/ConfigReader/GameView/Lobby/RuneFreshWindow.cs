...
namespace HolyTech.View
{
    public class RuneRefreshWindow : BaseWindow
    {
        ...
        public void onClickWash()
        {
            ...
            EventCenter.Broadcast<EMessageType, string, Callback<bool>>((Int32)GameEventEnum.GameEvent_ShowLogicMessage, EMessageType.EMT_SureToWash, showStr, windowsCallBack);
        }
