...
namespace HolyTech.View
{
    public class MailWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<MailData>((Int32)GameEventEnum.GameEvent_UpdateMailInfo, UpdateMail); 
        ...
        {
            EventCenter.RemoveListener<MailData>((Int32)GameEventEnum.GameEvent_UpdateMailInfo, UpdateMail);
