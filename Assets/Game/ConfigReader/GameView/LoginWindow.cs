...
namespace HolyTech.View
{
    public class LoginWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_LoginError, LoginFail);//登录失败反馈
            ...
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SelectServer, SelectServer);//选择服务器
        ...
        {
            EventCenter.RemoveListener<EErrorCode>((Int32)GameEventEnum.GameEvent_LoginError, LoginFail);
            ...
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SelectServer, SelectServer);
