...
namespace HolyTech.Ctrl
{
    public class LoginCtrl : Singleton<LoginCtrl>
    {
        ...
        public void LoginError(int code)
        {
            ...
            EventCenter.Broadcast<EErrorCode>((Int32)GameEventEnum.GameEvent_LoginError, (EErrorCode)code);
        }
        ...
        public void SelectServer(int id)
        {
            ...
            EventCenter.Broadcast((Int32)GameEventEnum.GameEvent_SelectServer); 
        }       
