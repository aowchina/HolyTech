...
namespace HolyTech.GameState
{
    class LoginState : IGameState
    {
        ...
        public void Enter()
        {
            ...
            EventCenter.AddListener<FEvent>((Int32)GameEventEnum.GameEvent_InputUserData, OnEvent);
        ...
        {
            //移除监听器
            EventCenter.RemoveListener<FEvent>((Int32)GameEventEnum.GameEvent_InputUserData, OnEvent);
