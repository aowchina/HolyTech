...
namespace HolyTech.GameState
{
    class PlayState : IGameState
    {
        ...
        public void Enter()
        {
            ...
            //正常流程
            EventCenter.AddListener<UInt64>((Int32)GameEventEnum.GameEvent_GameOver, OnGameOver);//状态转换到GS_Over
            //新手引导流程
            ...
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_ReconnectToBatttle, OnReconnectToBatttle);       
            //获取地图信息
            GetMapType();
        }
        ...
        public void Exit()
        {
            ...
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_ReconnectToBatttle, OnReconnectToBatttle);     
