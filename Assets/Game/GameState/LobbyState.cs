    ...
    class LobbyState : IGameState
    {
        ...
        public void Enter()
        {
            ...
            if (!AudioManager.Instance.LoopAudioSource.isPlaying)
            {
             ...
             EventCenter.AddListener<FEvent>((Int32)GameEventEnum.GameEvent_IntoRoom, OnEvent); // 进入房间
             EventCenter.AddListener<FEvent>((Int32)GameEventEnum.GameEvent_Loading, OnEvent);// 转换加载状态
             EventCenter.AddListener<FEvent>((Int32)GameEventEnum.GameEvent_IntoHero, OnEvent);// 转换英雄选择状态
             ...
             EventCenter.AddListener((Int32)GameEventEnum.GameEvent_ReconnectToBatttle, ReconnectToBatttle);//快速战斗  
        ...
        public void Exit()
        {
            ...
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_ReconnectToBatttle, ReconnectToBatttle);    
