...
public class CPAddUI : MonoBehaviour
{
    ...
    public void SetCPAdd_Count(string count,GameObject temp)
    {
        ...
        HolyTech.Effect.EffectManager.Instance.CreateNormalEffect("effect/other/soul_death", PlayerManager.Instance.LocalPlayer.RealEntity.objAttackPoint.gameObject);
