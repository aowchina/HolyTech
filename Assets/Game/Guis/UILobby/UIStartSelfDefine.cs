...
public class UIStartSelfDefine : MonoBehaviour {
    ...
    void AddEvent() {
        ...
        EventCenter.AddListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskAddInBattle, StartSelfResult);
	...
	void OnDisable(){
		...
		EventCenter.RemoveListener<EErrorCode>((Int32)GameEventEnum.GameEvent_AskAddInBattle, StartSelfResult);
